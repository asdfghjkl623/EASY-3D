#ifndef _MPL_BASIC_BIT_MATRIX_H_
#define _MPL_BASIC_BIT_MATRIX_H_


#include <basic/basic_common.h>
#include <vector>

#define BIT_MATRIX_OUT_OF_BOUND_CHECK

#ifdef  BIT_MATRIX_OUT_OF_BOUND_CHECK
#define BIT_MATRIX_CHECK(x,y,w,h) if (x>=w || y>=h) throw "Index out of bounds"
#else
#define BIT_MATRIX_CHECK(x,y,w,h)
#endif 
...
public:
	...
	bool is_set(unsigned x, unsigned y) const
	{
		BIT_MATRIX_CHECK(x, y, m_Width, m_Height);
		return m_Matrix[y].is_set(x);
	}
...
#endif // _MPL_BASIC_BIT_MATRIX_H_
